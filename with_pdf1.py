...
for match in pattern.finditer(text):
    ...
    name = re.sub(r"\s+", " ", match.group(2).strip())  # remove line breaks in names
...
# === STEP 4: Build formatted text (same as console output) ===
output_lines = []
